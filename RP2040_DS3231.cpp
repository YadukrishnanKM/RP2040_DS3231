 ...
 */
 void DS_3231::set_time_12_hr(uint8_t *Time_setup){
 ...
 * @param *Time_setup location to time array
 */
 void DS_3231::set_time_24_hr(uint8_t *Time_setup){
    uint8_t initial_loc = Addr_Seconds;
    for (uint8_t i = 0; i < 7; i++)
    {
        Time_setup[i] = BCD(Time_setup[i]);
 ...
 */
 void DS_3231::get_time(uint8_t *location){
    uint8_t initial_loc = Addr_Seconds;
    #ifdef I2C1
    i2c_read_blocking(i2c1,DS3231_adddr,location,sizeof(uint8_t[7]),false);
    #else
    i2c_write_blocking(i2c0,DS3231_adddr,&initial_loc,sizeof(uint8_t),true);
    i2c_read_blocking(i2c0,DS3231_adddr,location,sizeof(uint8_t[7]),false);
    #endif
 ...
 */
 void DS_3231::set_Alarm(bool Alarm, bool DY_DT, bool hrs_fmt, uint8_t *data){
 ...
 */
 void DS_3231::control_status_write(uint8_t data){
 ...
 * @param data the 8bit data to be written
 */
 void DS_3231::control_write(uint8_t data){
 ...
 */
 void DS_3231::get_time_from_bcd(uint8_t *location, uint8_t length){
 ...
 * @param Type_set 3
 */
 void DS_3231::Alarm_Bits_Mask_1(uint8_t Type_set){
 ...
 * @param Type_set 2
 */
 void DS_3231::Alarm_Bits_Mask_2(uint8_t Type_set){
 ...
 * @param Type_set 3
 */
 void DS_3231::set_sq_wave_freq(uint8_t Type_set){
 ...
 */
uint8_t DS_3231::BCD(uint8_t time){
...
unsigned int DS_3231::bcd_to_binary(unsigned int bcd) {
