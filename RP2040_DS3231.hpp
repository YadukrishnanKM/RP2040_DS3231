...
class DS_3231{
     ...
     */
    void set_time_12_hr(uint8_t *Time_setup);

    /**
     * This will set the RTC time in 24 Hour mode
     * @param *Time_setup location to time array
     */
    void set_time_24_hr(uint8_t *Time_setup);
     ...
     */
    void get_time(uint8_t *location);
     ...
     */
    void set_Alarm(bool Alarm, bool DY_DT, bool hrs_fmt, uint8_t *data);
     ...
     */
    void control_status_write(uint8_t data);
     ...
     * @param Type_set 3
     */
    void Alarm_Bits_Mask_1(uint8_t Type_set);
     ...
     * @param Type_set 2
     */
    void Alarm_Bits_Mask_2(uint8_t Type_set);
     ...
     */
     void get_time_from_bcd(uint8_t *location, uint8_t length);
     ...
     * @param Type_set 3
     */
    void set_sq_wave_freq(uint8_t Type_set);
    ...
    void write_byte(uint8_t data, uint8_t location);

    void write_array(uint8_t *data, uint8_t start_location,size_t data_size);
